...
public class Runner {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// STEP 4 - execute our query update
			System.out.println("Update a record from the db");
			stmt = conn.createStatement();
			
			String sql = "UPDATE students set age=20  WHERE id=2";
			stmt.execute(sql);
			
			
			// wewant to read from the db 
			 sql = "SELECT id, fName,sName,age FROM students";
//			 sql = "SELECT id, fName,sName,age FROM students where id ='2";
